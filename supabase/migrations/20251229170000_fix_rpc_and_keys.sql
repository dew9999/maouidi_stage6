-- Migration: Fix RPC Ambiguity & Configure Payment Keys
-- Date: 2025-12-29
-- Purpose: 
-- 1. Resolve "Ambiguous Function" error by dropping and recreating book_appointment
-- 2. Configure Chargily Secret Key in app_config
-- 3. Ensure all payment logic is encapsulated in database functions

-- ============================================================================
-- PART 1: FIX RPC AMBIGUITY
-- ============================================================================
...
-- Recreate the SINGLE, DEFINITIVE version of book_appointment
...
BEGIN
  ...
  IF partner_data.category = 'Homecare' THEN
    -- If paid via webhook, this comes in as 'Confirmed' + 'paid'. 
    -- If called manually/unpaid, defaults to 'Pending'.
...
-- ============================================================================
-- Update/Insert Chargily Secret Key
INSERT INTO "public"."app_config" ("key", "value", "description")
VALUES 
    ('chargily_secret_key', 'test_sk_FuVw05JCyPnpmfSdfVAm0xi93MU1exfsNiRVXuw9', 'Chargily API Secret Key'),
...
-- Ensure RLS allows service_role (Edge Function) to read this
