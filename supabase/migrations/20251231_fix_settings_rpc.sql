-- 1. Explicitly Drop existing functions to allow return type changes
DROP FUNCTION IF EXISTS "public"."get_full_partner_profile"("uuid");
DROP FUNCTION IF EXISTS "public"."update_full_partner_profile"("uuid", "text", "text", "text", "integer", "text", "text", "text", "boolean", "text", "boolean");

-- 2. Update GET RPC to return missing profile fields
...
-- 3. Update UPDATE RPC to accept new params
